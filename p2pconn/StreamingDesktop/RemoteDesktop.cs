    ...
    public static class RemoteDesktop
    {
        ...
        public static void StartDesktop()
        {
            try
            {
                ...
                startAForgeVideo();
                DesktopRunning = true;
                GlobalVariables.Root.Writetxtchatrom("Green", "开始共享桌面");
            }
            catch (Exception ex)
            {
                GlobalVariables.Root.Writetxtchatrom("Red", "启动桌面(): " +  ex.Message);
            }
        }
        ...
        public static void StopDesktop()
        {
            try
            {
                ...
                GlobalVariables.Root.Writetxtchatrom("Green", "停止共享桌面 " );
            }
            catch (Exception ex)
            {
                GlobalVariables.Root.Writetxtchatrom("Red", " 停止桌面() " + ex.Message);
            }
        }
        private static void stopAForgeVideo()
        {
            ...
            {
                GlobalVariables.Root.Writetxtchatrom("Red", "停止视频源: " + ex.Message);
            }
        }
        #endregion
        ...
        private static void video_NewFrame(object sender, NewFrameEventArgs eventArgs)
        {
            ...
            try
                ...
                {
                    GlobalVariables.Root.Writetxtchatrom("Red", "停止共享桌面: " + ex.Message);
                    StopDesktop();
                    GC.Collect();
                }
        }
