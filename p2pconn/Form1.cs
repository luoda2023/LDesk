...
namespace p2pconn
{
    public partial class Form1 : Form
    {
        ...
        public string myname = "我";
        public string peername = "对端";
        ...
        private void connect()
        {
            try
            {
                ...
                if (connection == null)
                {
                    ...
                    label4.Invoke((MethodInvoker)(() => label4.Text = "无法建立到 " + remoteIp + " 的 P2P 连接")); 
                    return;
                }
                try
                {
        ...
        private P2pEndPoint GetExternalEndPoint(Socket socket)
        {
            ...
            MessageBox.Show("无法获取您的公网 IP，未能找到可用的 STUN 服务器 :-( ");
            return null;
        }
        ...
        public UdtSocket PeerConnect(Socket socket, string remoteAddr, int remotePort)
        {
            ...
            while (!bConnected)
            {
                try
                {
                    ...
                    label4.Invoke((MethodInvoker)(() => label4.Text = "等待 " + sleepTimeToSync + "  秒以与对端同步"));
                    ...
                    retry++;
                    label4.Invoke((MethodInvoker)(() => label4.ForeColor = Color.Black));
                    label4.Invoke((MethodInvoker)(() => label4.Text = "第 " + retry + " 次尝试连接 " + remoteAddr + ":" + remotePort));
                    ...
                    label4.Invoke((MethodInvoker)(() => label4.Text = "已成功连接到 " + remoteAddr + ":" + remotePort));
        ...
        private void btn_paste_Click(object sender, EventArgs e)
        {
            ...
            {
                txtRemoteIP.Text = "";
                MessageBox.Show("请粘贴对端的 host:port，而不是您自己的");
            }
        }
        ...
        private void SaveDataToJsoin()
        {
            ...
            {
                MessageBox.Show("STUN 服务器列表已保存至: " + StunServersJson);
            }
        }
