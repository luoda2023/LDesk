    ...
    public static class SenderReceiver
    {
        ...
        static internal void Run(Object conn)
        {
            ...
            while (isConnected && netStream.CanRead) 
            {
                    ...
                    if (message != null && message.Length > 0)
                    {
                        ...
                        switch (words[0])
                        {
                            case "peer":
                                ...
                                GlobalVariables.Root.Text = "已连接到 => " + words[1];
                            ...
                            case "b":
                                try
                                {
                                    ...
                                    if (int.TryParse(words[2], out value))
                                    {
                                        ...
                                        if (tempBytes != null && tempBytes.Length > 0)
                                        {
                                            ...
                                            GlobalVariables.Root.WriteKB("帧大小: " + Functions.FormatFileSize(tempBytes.Length));
                                            ...
                                            {
                                                GlobalVariables.Root.WriteFPS("帧率: " + FPS);
                                                FPS = 0;
                                ...
                                {
                                    GlobalVariables.Root.Writetxtchatrom("Red", "接收画面流: " + ex.ToString());
                            ...
                            case "m":
                                ...
                                {
                                    GlobalVariables.Root.Writetxtchatrom("Red", "鼠标移动: " + ex.Message);
                                }
                                break;
                            ...
                            case "mw":
                                ...
                                {
                                    GlobalVariables.Root.Writetxtchatrom("Red", "鼠标滚轮: " + ex.Message);
                                }
                                break;
                            ...
                            case "ku":
                                ...
                                {
                                    GlobalVariables.Root.Writetxtchatrom("Red", "按键抬起: " + ex.Message.ToString());
                                }
                                break;
                            ...
                            case "kd":
                                ...
                                {
                                    GlobalVariables.Root.Writetxtchatrom("Red", "按键按下: " + ex.Message.ToString());
                                }
                                break;
                        ...
                        if (words[0] == "mu" || words[0] == "md")
                        {
                            ...
                            {
                                GlobalVariables.Root.Writetxtchatrom("Red", "鼠标按下/抬起: " + ex.Message);
                            }
                        } 
                    }
                ...
                {
                    GlobalVariables.Root.Writetxtchatrom("Red", "获取数据: " + e.Message);
                }
            }
        }
    #endregion
    ...
    static internal void SendMessage(string message)
        {
            ...
            {
                GlobalVariables.Root.Writetxtchatrom("Red", "发送消息: " + ex.Message);
            }
        }
        #endregion
